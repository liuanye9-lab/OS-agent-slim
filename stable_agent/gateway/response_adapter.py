    ...
    def to_mcp_content(self, result: StableAgentToolResult) -> dict[str, Any]:
        ...
        return {
            ...
            "structuredContent": {
                ...
                "current_stage": result.data.get("current_stage") or result.data.get("stage", "execution"),
                "progress_pct": result.data.get("progress_pct"),
                "status_text_zh": result.data.get("status_text_zh") or result.plain_text_zh or result.plain_text,
                "status_text_en": result.data.get("status_text_en") or result.plain_text_en or result.plain_text,
                "plain_text_zh": result.plain_text_zh or result.plain_text,
                "plain_text_en": result.plain_text_en or result.plain_text,
                "avatar_state": result.data.get("avatar_state"),
                "decision_summary_zh": result.data.get("decision_summary_zh"),
                "decision_summary_en": result.data.get("decision_summary_en"),
                "why_zh": result.data.get("why_zh"),
                "why_en": result.data.get("why_en"),
            },
